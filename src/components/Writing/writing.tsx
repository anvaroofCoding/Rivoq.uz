...
const Writing = () => {
	...
	return (
		<div className='h-screen overflow-y-auto bg-gray-50 dark:bg-neutral-900'>
				...
				<div className='space-y-4'>
					{loading
						...
						: posts.map(post => (
								<div
									key={post.id}
									className='flex gap-3 items-start p-4 rounded-lg shadow border bg-white dark:bg-neutral-800'
								>
									<img
										src={post.avatar}
										alt={post.name}
